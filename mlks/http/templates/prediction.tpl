<div class="container">
    <nav class="breadcrumb" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">%(MODEL_TYPE)s prediction</a></li>
        </ul>
    </nav>
...
<div class="container">
    <h1 class="title"><span class="pictogram">%(ICON)s</span> %(MODEL_TYPE)s prediction result</h1>
